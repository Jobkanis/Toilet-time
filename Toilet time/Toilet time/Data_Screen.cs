...
namespace Toilet_time
{
    public class Screen
    {
        ...
        public Screen(Iterator<Fallable_Object> fallable_objects, Iterator<Stable_Object> stable_objects, Iterator<iObject> gui_stuff, Iterator<iObject> Interacting_Objects)
        {
